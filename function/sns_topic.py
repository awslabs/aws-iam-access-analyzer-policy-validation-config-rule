...
class SNSTopicConfigRuleHandler(PolicyValidationConfigRuleHandler):
	...
	def get_policy_document(self, configuration_item):
		topic_policy = configuration_item['configuration'].get('Policy')
		if topic_policy is None:
			return None

		return json.loads(topic_policy)
